...
namespace StudioCRM.Infrastructure.Migrations
{
    ...
    [Migration("20260911214629_AddClientLocationMemberships")]
    partial class AddClientLocationMemberships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.ClientLocationMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("GroupAccessEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("ClientLocationMemberships");
                });
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.ClientMilestone", b =>
                {
                    ...
                    b.Property<int?>("RewardClaimedByUserId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RewardClaimedByUserId");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.ClientPayment", b =>
                {
                    ...
                    b.Property<decimal>("AppliedToPackageAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("BalanceCreditAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<DateTime?>("ProviderPayoutDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("ProviderSettledAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("ReceiptIssuedByUserId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ProviderPayoutDate");

                    b.HasIndex("ProviderSettlementId");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.CompanyExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.ExternalCalendarEvent", b =>
                {
                    ...
                    b.Property<string>("CategoryColorsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("MappingWarningsJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.LegalEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("BlikPhoneNumber")
                        .HasMaxLength(32)
                    ...
                    b.Property<string>("TransferTitleTemplate")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.Location", b =>
                {
                    ...
                    b.Property<int>("FiscalReceiptMode")
                        .HasColumnType("integer");

                    b.Property<string>("FiscalRegisterName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("FiscalRegisterNumber")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.PaymentProviderAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("WebhookSecretConfigured")
                        .HasColumnType("boolean");

                    b.HasKey("Id");

                    b.HasIndex("LegalEntityId", "Provider", "IsActive");

                    b.HasIndex("LocationId", "Provider", "IsActive");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.Session", b =>
                {
                    ...
                    b.Property<string>("OutlookCategoriesJson")
                        .HasColumnType("text");

                    b.Property<string>("OutlookCategoryColorsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PrimaryOutlookCategory")
                        .HasColumnType("text");

                    b.Property<int?>("PublicCapacity")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.Trainer", b =>
                {
                    ...
                    b.Property<string>("OutlookCategoryColor")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("OutlookCategoryName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<DateTime?>("TeamJoinedDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.TrainerContractLocation", b =>
                {
                    b.Property<int>("TrainerContractId")
                        .HasColumnType("integer");

                    b.Property<int>("LocationId")
                        .HasColumnType("integer");

                    b.HasKey("TrainerContractId", "LocationId");

                    b.HasIndex("LocationId");

                    b.ToTable("TrainerContractLocations");
                });
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.ClientMilestone", b =>
                {
                    ...
                    b.HasOne("StudioCRM.Domain.Entities.User", "RewardClaimedByUser")
                        .WithMany()
                        .HasForeignKey("RewardClaimedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("RewardClaimedByUser");
                });
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.ClientPayment", b =>
                {
                    ...
                    b.HasOne("StudioCRM.Domain.Entities.LegalEntity", "LegalEntity")
                        .WithMany()
                    ...
                    b.HasOne("StudioCRM.Domain.Entities.PaymentProviderAccount", "PaymentProviderAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.TrainerContractLocation", b =>
                {
                    b.HasOne("StudioCRM.Domain.Entities.Location", "Location")
                        .WithMany("TrainerContractLocations")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudioCRM.Domain.Entities.TrainerContract", "TrainerContract")
            ...
            modelBuilder.Entity("StudioCRM.Domain.Entities.Location", b =>
                {
                    ...
                    b.Navigation("TrainerContractLocations");
